const e=[["meta",1],["vim",1],["nixos",2],["vue",1],["webdev",1],["postgresql",1]],t=[],s=[{id:1,title:"My workflow",subtitle:"Keeping on track with workflow",date:"28/12/2023",tags:["meta","vim","nixos"],file:"posts/my-workflow.md",slug:"my-workflow",pinned:0,content:`In order to keep myself on track I wanted to document my workflow. So in order to do that this post will be kept up to date every 3 months or so with additional input and changes to how I work.
